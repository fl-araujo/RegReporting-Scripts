...
cp_id_count_input3 = 0  # Counter for CP_IDs in Input File 3 (aggregated over AC2M files)
instrument_counts_input2 = {
    'T1M:BBK_ANCRDT_INSTRMNT_C': set(),
    'T1M:BBK_ANCRDT_FNNCL_C': {
        'count': 0,
        'otstndng_nml_amt_sum': 0.0,
        'accrd_intrst_sum': 0.0
    },
    'T1M:BBK_ANCRDT_ENTTY_INSTRMNT_C': 0
}
...
def write_results_to_txt(output_file):
    with open(output_file, 'w') as f:
        ...
        f.write("Obs: One counterparty, corresponding to the TRB IT Branch, appears twice in the input files but is correctly reported only once in the RIAD dataset. As a result, the output file will reflect one fewer counterparty.\n")
        ...
        f.write(f"Obs: As TRB does not have a default status, the default status dataset will reflect one fewer counterparty.\n")
...
def display_results():
    ...
    print("One counterparty, corresponding to the TRB IT Branch, appears twice in the input files but is correctly reported only once in the RIAD dataset. As a result, the output file will reflect one fewer counterparty.\n")
    ...
    print(f"Obs: As TRB does not have a default status, the default status dataset will reflect one fewer counterparty.\n")

# --- Main Logic ---

# Process Input File 1 (RIAD)
input_file_1 = 'input_files/rdac_10012345_202503_5071.xml'
process_input_file_1(input_file_1)

# Process Input File 2 (AC1M)
input_file_2 = 'input_files/ac1m_10012345_202503_5072_1e.xml'
process_input_file_2(input_file_2)

# Process Input File 3 (AC2M)
input_file_3 = 'input_files/ac2m_10012345_202503_5073_1e.xml'
process_input_file_3(input_file_3)

# --- Additional Files ---

# Process Additional AC1M File
input_file_4 = 'input_files/ac1m_99004014_202503_5075_1e.xml'
process_input_file_2(input_file_4)

# Process Additional AC2M File
input_file_5 = 'input_files/ac2m_99004014_202503_5076_1e.xml'
process_input_file_3(input_file_5)

# Write results to a text file
output_file_path = 'output_files/AnaCredit_Monthly_Report_Output_Validation_Results.txt'
