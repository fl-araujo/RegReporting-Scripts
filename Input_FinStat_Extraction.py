...
try:
    ...
    df_profit_loss = pd.DataFrame(columns=[
        'ORGUNITID', 'CPTYID', 'AMOUNT', 'LKUPPERIODINDICATOR', 'LKUPCURRENCY', 'LKUPINCOMEEXPENSE', 
        'LKUPPLCLASSIFICATION', 'LKUPPRODTYPE', 'LKUPRESIDENCEOVERRIDE', 'LKUPSECTOROVERRIDE', 
        'LKUPINDUSTRYOVERRIDE', 'LKUPACCOUNTINGPORTFOLIOTYPE', 'LKUPASSETLIABILITYOFUNDERLYING', 
        'LKUPHEDGING', 'LKUPISSUBORDINATED', 'LKUPISINTERGROUP', 'LKUPISINTRAGROUP', 'LKUPISOWNISSUED', 
        'CUSTOM1', 'CUSTOM2', 'CUSTOM3', 'LKUPISQUOTED', 'LKUPCOLLATERALTYPE', 'LKUPISINVESTMENTPROPERTY', 
        'GLACCOUNT', 'LKUPISNONPERFORMING', 'NOTICEPERIOD', 'LKUPLOANDEPOSITTERM', 'LKUPIMPAIRMENTSTAGE', 
        'LKUPECONOMICHEDGE', 'LKUPISGENERALALLOWANCE', 'EXCLUSIONFLAG', 'LKUPISDERECOGNISE'
    ])
